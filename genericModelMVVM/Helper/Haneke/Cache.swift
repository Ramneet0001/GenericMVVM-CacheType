...
open class Cache<T: DataConvertible> where T.Result == T, T : DataRepresentable {
    ...
    public init(name: String) {
        ...
        memoryWarningObserver = notifications.addObserver(forName: .UIApplicationDidReceiveMemoryWarning, object: nil, queue: .main, using: { (notification) in
...
//            }
    ...
    deinit {
        let notifications = NotificationCenter.default
        notifications.removeObserver(memoryWarningObserver as Any, name:.UIApplicationDidReceiveMemoryWarning, object: nil)
    }
